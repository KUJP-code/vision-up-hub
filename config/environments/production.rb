...
Rails.application.configure do
  ...
  config.x.device_lock_enforced = false # lock devices in prod
  ...
  # Allow specific redirect hosts
  config.action_controller.default_url_options = {
    host: 'www.vision-up.app',
    allowed_redirect_hosts: ['hub.kids-up.app', 'vision-up.app']
  }
  ...
  config.active_record.encryption.primary_key = ENV.fetch('ACTIVE_RECORD_ENCRYPTION_KEY', nil)
